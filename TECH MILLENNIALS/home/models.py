...
class AnalysisResult(models.Model):
    ...
    video_report = models.CharField(max_length=255, null=True, blank=True)
    overall_report = models.CharField(max_length=255, null=True, blank=True)
    conclusion = models.CharField(max_length=255, null=True, blank=True)

class TelegramAnalysis(models.Model):
    name = models.CharField(max_length=100)
    channel_name= models.CharField(max_length=100)
    channel_report = models.CharField(max_length=255, null=True, blank=True)
